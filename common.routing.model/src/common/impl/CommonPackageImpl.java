...
public class CommonPackageImpl extends EPackageImpl implements CommonPackage {
	 ...
	 * @generated
	 */
	public EAttribute getRequest_Time() {
	 ...
	 * @generated
	 */
	public EAttribute getRequest_FromStopId() {
	 ...
	 * @generated
	 */
	public EAttribute getRequest_ToStopId() {
	 ...
	 * @generated
	 */
	public EAttribute getRequest_FromLat() {
	 ...
	 * @generated
	 */
	public EAttribute getRequest_FromLon() {
	 ...
	 * @generated
	 */
	public EAttribute getRequest_ToLat() {
	 ...
	 * @generated
	 */
	public EAttribute getRequest_ToLon() {
	 ...
	 * @generated
	 */
	public EAttribute getRequest_Timezone() {
	...
	public void createPackageContents() {
		...
		createEAttribute(requestEClass, REQUEST__TIME);
		createEAttribute(requestEClass, REQUEST__DATE);
		createEAttribute(requestEClass, REQUEST__FROM_STOP_ID);
		createEAttribute(requestEClass, REQUEST__TO_STOP_ID);
		createEAttribute(requestEClass, REQUEST__FROM_LAT);
		...
		createEAttribute(requestEClass, REQUEST__TIMEZONE);
	}
	...
	public void initializePackageContents() {
		...
		initEAttribute(getRequest_Time(), ecorePackage.getEString(), "time", null, 0, 1, Request.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getRequest_Date(), ecorePackage.getEString(), "date", null, 0, 1, Request.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getRequest_FromStopId(), ecorePackage.getEString(), "fromStopId", null, 0, 1, Request.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getRequest_ToStopId(), ecorePackage.getEString(), "toStopId", null, 0, 1, Request.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getRequest_FromLat(), ecorePackage.getEDouble(), "fromLat", null, 0, 1, Request.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getRequest_Timezone(), ecorePackage.getEString(), "timezone", null, 0, 1, Request.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
