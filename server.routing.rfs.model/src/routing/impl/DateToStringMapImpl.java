...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Date To String Map</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public class DateToStringMapImpl extends MinimalEObjectImpl.Container implements BasicEMap.Entry<String,EList<String>> {
	...
	protected EClass eStaticClass() {
		return RoutingPackage.Literals.DATE_TO_STRING_MAP;
	}
	...
	public EList<String> getTypedValue() {
		if (value == null) {
			value = new EDataTypeUniqueEList<String>(String.class, this, RoutingPackage.DATE_TO_STRING_MAP__VALUE);
		}
		return value;
	}
